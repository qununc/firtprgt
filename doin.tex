...
\begin{tikzpicture}
	...
	\addplot[blue, ultra thick]{6/x};
	\addlegendentry{$\frac{6}{x}$}	
	\end{axis}
\end{tikzpicture}
\begin{tikzpicture}
	\begin{axis}[width=12cm, height=6cm, samples=250, domain=-10:10, restrict y to domain=-20:20, legend pos=outer north east]
	\addplot[blue, dotted, ultra thick]{6/x};
	\addlegendentry{$\frac{6}{x}$}	
	\addplot[blue, ultra thick]{6/(x+3};
	\addlegendentry{$\frac{6}{x+3}$}	
	\end{axis}
\end{tikzpicture}
\begin{tikzpicture}
	\begin{axis}[width=12cm, height=6cm, samples=250, domain=-10:10, restrict y to domain=-20:20,legend pos=outer north east]
	\addplot[blue, dotted, ultra thick]{6/(x+3)};
	\addlegendentry{$\frac{6}{x+3}$}
	\addplot[blue, ultra thick]{-6/(x+3)};
	\addlegendentry{$-\frac{6}{x+3}$}	
	\end{axis}
...
\begin{tikzpicture}
	...
	\addplot[blue, ultra thick]{log10(x)};
	\addlegendentry{$\lg{x}$}	
	\addplot[red, dotted, ultra thick]{3*log10(x)};
	\addlegendentry{$3\lg{x}$}	
	\end{axis}
\end{tikzpicture}
\begin{tikzpicture}
	\begin{axis}[width=12cm, height=6cm, samples=250, domain=-6:6,legend pos=outer north east]
	\addplot[blue, dotted, ultra thick]{3*log10(x)};
	\addlegendentry{$3\lg{x}$}	
	\addplot[blue, ultra thick]{3*log10(x+1)};
	\addlegendentry{$3\lg{x+1}$}	
	\end{axis}
\end{tikzpicture}
\begin{tikzpicture}
	\begin{axis}[width=12cm, height=6cm, samples=250, domain=-6:6,legend pos=outer north east]
	\addplot[blue, dotted, ultra thick]{3*log10(x+1)};
	\addlegendentry{$3\lg{x+1}$}
	\addplot[blue, ultra thick]{-3*log10(x+1)};
	\addlegendentry{$-3\lg{x+1}$}	
	\end{axis}
...
\begin{tikzpicture}
	...
	\addplot[blue, dotted, ultra thick]{-3*log10(x+1)};
	\addlegendentry{$-3\lg{x+1}$}
	\addplot[blue, ultra thick]{2-3*log10(x+1)};
	\addlegendentry{$2-3\lg{x+1}$}
	\end{axis}
\end{tikzpicture}
\newline\newline\newline
\begin{tikzpicture}
...
\addplot [
    ...
    {2-3*log10(x+1)};
    \addlegendentryexpanded{$2-3\lg{x+1}$}
    \addlegendimage{empty legend}
\end{axis}
\end{tikzpicture}
\end{center}
